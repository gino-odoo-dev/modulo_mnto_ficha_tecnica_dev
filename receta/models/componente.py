...
class Componente(models.Model):
    ...
    codigosecuencia_id = fields.Many2one('cl.product.secuencia', string='Código de Secuencia')
    compra_manufactura_id = fields.Many2one( 'cl.product.compramanufactura', string='Compra/Manufactura', ondelete='set null')
    ...
    departamento_id = fields.Many2one('cl.departamento', string='Departamento', store=True)
    articulo_id = fields.Many2one('cl.product.articulo', string='Articulo', required=False, ondelete='cascade')
